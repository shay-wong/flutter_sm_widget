...
// What was the MAlertDialog's ButtonBar when many of these tests were written,
...
void main() {
  ...
  testWidgets('MAlertDialog custom clipBehavior', (WidgetTester tester) async {
    const MAlertDialog dialog = MAlertDialog(
      actions: <Widget>[],
  ...
  testWidgets('Dialog hides underlying semantics tree', (WidgetTester tester) async {
    ...
    showDialog<void>(
      context: context,
      builder: (BuildContext context) {
        return const MAlertDialog(title: Text(alertText));
      },
    );
  ...
  testWidgets('MAlertDialog.actionsPadding defaults', (WidgetTester tester) async {
    ...
    // The [MAlertDialog] is the entire screen, since it also contains the scrim.
    // The first [Material] child of [MAlertDialog] is the actual dialog
    // itself.
    final Size dialogSize = tester.getSize(
      find
          .descendant(
            of: find.byType(MAlertDialog),
  ...
  group('Dialog children padding is correct', () {
    ...
    for (final double textScaleFactor in textScaleFactors) {
      testWidgets(
          'MAlertDialog padding is correct when only icon and actions are specified [textScaleFactor]=$textScaleFactor',
      ...
      testWidgets(
          'MAlertDialog padding is correct when only icon, title and actions are specified [textScaleFactor]=$textScaleFactor',
          (WidgetTester tester) async {
        final MAlertDialog dialog = MAlertDialog(
          icon: icon,
          title: title,
      ...
      for (final bool isM3 in <bool>[true, false]) {
        testWidgets(
            'MAlertDialog padding is correct when only icon, content and actions are specified [textScaleFactor]=$textScaleFactor [isM3]=$isM3',
            (WidgetTester tester) async {
          final MAlertDialog dialog = MAlertDialog(
            icon: icon,
            content: content,
      ...
      testWidgets(
          'MAlertDialog padding is correct when only title and actions are specified [textScaleFactor]=$textScaleFactor',
          (WidgetTester tester) async {
        final MAlertDialog dialog = MAlertDialog(
          title: title,
          actions: actions,
      ...
      testWidgets(
          'MAlertDialog padding is correct when only content and actions are specified [textScaleFactor]=$textScaleFactor',
          (WidgetTester tester) async {
        final MAlertDialog dialog = MAlertDialog(
          content: content,
          actions: actions,
      ...
      testWidgets(
          'MAlertDialog padding is correct when title, content, and actions are specified [textScaleFactor]=$textScaleFactor',
          (WidgetTester tester) async {
        final MAlertDialog dialog = MAlertDialog(
          title: title,
          content: content,
  ...
  testWidgets('Dismissible.confirmDismiss defers to an MAlertDialog', (WidgetTester tester) async {
    ...
    await tester.tapAt(Offset.zero); // Tap outside of the MAlertDialog
    await tester.pumpAndSettle();
    expect(dismissedItems, <int>[0]);
    expect(find.text('0'), findsNothing);
    expect(find.text('1'), findsOneWidget);
                ...
                onPressed: () {
                  showDialog<void>(
                    ...
                    builder: (BuildContext innerContext) {
                      return const MAlertDialog(title: Text('Title'));
                    },
                  );
                },
  ...
  testWidgets('DialogRoute is state restorable', (WidgetTester tester) async {
    ...
    expect(find.byType(MAlertDialog), findsNothing);
  ...
  testWidgets('MAlertDialog.actionsAlignment', (WidgetTester tester) async {
    ...
    expect(tester.getTopLeft(find.byType(MAlertDialog)).dx, 0);
    expect(tester.getTopRight(find.byType(MAlertDialog)).dx, 800);
