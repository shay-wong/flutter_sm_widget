...
import 'package:example/text_field//common/toggle_button.dart';
import 'package:example/text_field//special_text/at_text.dart';
import 'package:example/text_field//special_text/dollar_text.dart';
import 'package:example/text_field//special_text/emoji_text.dart' as emoji;
...
class _TextDemoState extends State<TextDemo> {
      ...
      child: Scaffold(
        ...
        body: Column(
          children: <Widget>[
            ...
            MTextField(
              bringIntoView: (p0) => _bringIntoView = p0,
              minLines: 1,
              maxLines: 2,
  ...
  void insertText(String text) {
    ...
    SchedulerBinding.instance.addPostFrameCallback((Duration timeStamp) {
      _bringIntoView?.call(_textEditingController.selection.base);
  ...
  void manualDelete() {
    //delete by code
    final TextEditingValue value0 = _textEditingController.value;
    final TextSelection selection = value0.selection;
    if (!selection.isValid) {
      return;
    }

    TextEditingValue value;
    final String actualText = value0.text;
