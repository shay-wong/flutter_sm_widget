        ...
        child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                Text.rich(TextSpan(children: <TextSpan>[
                  TextSpan(
                      ...
                      recognizer: TapGestureRecognizer()
                        ..onTap = () {
                          launchUrl(Uri.parse('https://github.com/flutter/flutter/issues/24335'));
                        }),
                  const TextSpan(text: '/'),
                  TextSpan(
                      text: '24337',
                      ...
                      recognizer: TapGestureRecognizer()
                        ..onTap = () {
                          launchUrl(Uri.parse('https://github.com/flutter/flutter/issues/24337'));
                        }),
                ])),
                const Text(
                ...
                Text(
                  '错误演示 12345',
                  style: TextStyle(background: Paint()..color = Colors.orange.withOpacity(0.4)),
                ),
                Container(
                  height: 20.0,
                ),
                ...
                MText.rich(
                  text: TextSpan(
                    children: <TextSpan>[
                      ...
                      BackgroundTextSpan(
                        text: '错误演示 12345  错误演示 12345  错误演示 12345  错误演示 12345  错误演示 12345  错误演示 12345',
                ...
                MText.rich(
                  ...
                  BackgroundTextSpan(
                      text: 'This text has nice background with borderradius,no mattter how many line,it likes nice',
                ...
                MText.rich(
                  ...
                  BackgroundTextSpan(
                      ...
                      clipBorderRadius: const BorderRadius.all(Radius.circular(3.0)),
                      paintBackground: (BackgroundTextSpan backgroundTextSpan, Canvas canvas, Offset offset,
                          TextPainter? painter, Rect rect,
                          {Offset? endOffset, TextPainter? wholeTextPainter}) {
                        final Rect textRect = offset & painter!.size;

                        ///top-right
                        if (endOffset != null) {
                          final Rect firstLineRect = offset & Size(rect.right - offset.dx, painter.height);
                          ...
                          final int fullLinesAndLastLine = ((endOffset.dy - offset.dy) / painter.height).round();
                          ...
                          for (int i = 0; i < fullLinesAndLastLine; i++) {
                            ...
                            if (i == fullLinesAndLastLine - 1) {
                              final Rect lastLineRect = Offset(0.0, y) & Size(endOffset.dx, painter.height);
                              if (backgroundTextSpan.clipBorderRadius != null) {
                                canvas.save();
                                canvas.clipPath(Path()
                                  ..addRRect(backgroundTextSpan.clipBorderRadius!
                            ...
                            ///draw full line
                              ...
                              final Rect fullLineRect = Offset(0.0, y) & Size(rect.width, painter.height);
